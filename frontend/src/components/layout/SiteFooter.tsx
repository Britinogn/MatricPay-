    ...
    <>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div className="md:col-span-1">
              ...
              <p className="mt-3 text-sm text-(--text-muted) leading-relaxed">
                ...
                institutions. We help organizers create payment campaigns, track
                collections in real time, and verify student payments without the
                usual administrative stress. Powered by Paystack, we ensure every
                transaction is safe, transparent, and easy to reconcile.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-2 text-sm text-(--text-muted)">
                <Link to="/pricing" className="hover:text-(--text-primary)">
                  Pricing
                </Link>
                <Link to="/faq" className="hover:text-(--text-primary)">
                  FAQ
                </Link>
                <Link to="/security" className="hover:text-(--text-primary)">
                  Security
                </Link>
                <Link to="/how-it-works" className="hover:text-(--text-primary)">
                  How it works
      ...
      {showBackToTop && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-(--primary) text-white shadow-lg transition hover:bg-(--primary-hover) hover:scale-105"
        >
